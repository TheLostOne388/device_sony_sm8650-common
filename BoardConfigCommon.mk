...
TARGET_RECOVERY_UTILS_PROGS := mkfs.f2fs fsck.f2fs f2fsresize
TW_INCLUDE_F2FS_TOOLS := true
...
# Use vendor wifi implementation
BOARD_USES_VENDOR_WIFI_HAL := true
...
TARGET_INIT_VENDOR_LIB := //device/sony/sm8650-common:libinit_sm8650

# Recovery Tools
TARGET_RECOVERY_UTILS_PROGS += mkfs.f2fs
TW_INCLUDE_F2FS_TOOLS := true

BOARD_BOOTCONFIG += console=ttyMSM0,115200n8 earlycon=msm_geni_serial,0x04C8D000