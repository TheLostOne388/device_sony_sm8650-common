...
DEVICE_PATH := device/sony/sm8650-common
...
PRODUCT_PACKAGES += \
    ...
    android.hardware.media.c2@1.0-impl \
...
# Remove any existing sensor packages
PRODUCT_PACKAGES := $(filter-out sensors.dynamic_sensor_hal,$(PRODUCT_PACKAGES))
...
# Media HAL header paths
PRODUCT_HEADER_LIBRARIES += \
    android.hardware.media.omx@1.0-headers

# Ensure OMX headers are built first
PRODUCT_PACKAGES += \
    android.hardware.media.omx@1.0-headers
